  ...
  return (
    <section className="mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-[1fr_1.2fr]">
      ...
      <div ref={ref} className="relative pl-12">
        ...
        <motion.div className="absolute bottom-2 left-[14px] top-2 w-0.5 origin-top bg-brand-500" style={{ scaleY: fill }} />
        ...
        <ol className="space-y-24">
          {STEPS.map((step, i) => (
            ...
            >
              <span className="absolute -left-12 top-0 flex h-8 w-8 items-center justify-center rounded-full border border-border bg-surface text-xs font-bold text-brand-500">
                {i + 1}
              </span>
